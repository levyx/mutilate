 ...
 ConnectionStats(bool _sampling = true) :
  ...
  static void print_header() {
    printf("%-7s %7s %7s %7s %7s %7s %7s %7s %7s\n",
           "#type", "avg", "std", "min", /*"1st",*/ "90th", "99th",
  ...
  void print_stats(const char *tag, AdaptiveSampler<Operation> &sampler,
    ...
    printf("%-7s %7.1f %7.1f %7.1f %7.1f %7.1f %7.1f %7.1f %7.1f",
           ...
           copy[0], copy[(l*1) / 100], copy[(l*90) / 100], copy[(l*99) / 100],
           copy[(l*99.9) / 100], copy[(l*99.99) / 100], copy[(l*99.999) / 100]
           );
    if (newline) printf("\n");
  }
  ...
  void print_stats(const char *tag, HistogramSampler &sampler,
    ...
    printf("%-7s %7.1f %7.1f %7.1f %7.1f %7.1f %7.1f %7.1f %7.1f",
           tag, sampler.average(),
           sampler.get_nth(0), sampler.get_nth(1), sampler.get_nth(90),
           sampler.get_nth(99), sampler.get_nth(99.9),
           sampler.get_nth(99.99), sampler.get_nth(99.999));
